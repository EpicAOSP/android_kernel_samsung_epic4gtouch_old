...
static void s5k5ccgx_flashtimer_handler(unsigned long data)
{
	...
	if (atomic_read(flash_status) == S5K5CCGX_FLASH_OFF)
		return;
#endif
...
void smdk_accessory_power(u8 token, bool active)
{
	...
	*/
	...
	if (system_rev >= 2)
		gpio_acc_5v = GPIO_ACCESSORY_OUT_5V;
#elif defined(CONFIG_MACH_P8) || defined(CONFIG_MACH_P8LTE)	/* for checking p8 3g and wifi */
	if (system_rev >= 4)
		gpio_acc_5v = GPIO_ACCESSORY_OUT_5V;
#endif
...
#endif
#endif
#if defined(CONFIG_VIDEO_SR200PC20)
	&s3c_device_i2c13,
#endif
