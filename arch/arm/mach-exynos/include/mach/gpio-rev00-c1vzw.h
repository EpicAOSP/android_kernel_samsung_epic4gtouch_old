...
#define CMC_IDPRAM_INT_IRQ_00	IRQ_EINT(27)
#define CMC_IDPRAM_INT_IRQ_01	IRQ_EINT(16)
...
#define CBP_DPRAM_INT_IRQ_00	IRQ_EINT(16)
#define CBP_DPRAM_INT_IRQ_01	IRQ_EINT(29)
