...
static unsigned int u1_sleep_gpio_table[][3] = {
	...
	{ EXYNOS4_GPA0(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* WIMAX_DBGEN_2.8V */
	{ EXYNOS4_GPA0(5),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* WIMAX_RESET_N */
#else
	{EXYNOS4_GPA0(3), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},
...
#if defined(CONFIG_TARGET_LOCALE_NA)
	{ EXYNOS4210_GPE0(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},  /* EBI2_WE_N */
	{ EXYNOS4210_GPE0(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},  /* CP_DPRAM_CS_N */
	{ EXYNOS4210_GPE0(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},  /* EBI2_OE_N */
	{ EXYNOS4210_GPE0(3),  S3C_GPIO_SLP_OUT1,	S3C_GPIO_PULL_NONE},
	{ EXYNOS4210_GPE0(4),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},  /* NAND_ADV_N */
#else
	...
	{ EXYNOS4_GPB(4),       S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE}, /* WIMAX_USB_EN */
				    ...
				    unsigned int (*gpio_table)[3])
{
	...
	if (!gpio_get_value(GPIO_WIMAX_EN)) {
		for (i = 0; i <= 6; i++) {
			if (i != 2) {
				s3c_gpio_slp_cfgpin(EXYNOS4_GPK3(i), S3C_GPIO_SLP_INPUT);
				s3c_gpio_slp_setpull_updown(EXYNOS4_GPK3(i), S3C_GPIO_PULL_DOWN);
			}
		}
	}
#endif /* CONFIG_TARGET_LOCALE_NA */
