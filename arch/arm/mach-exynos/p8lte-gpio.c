...
static struct gpio_init_data p8lte_init_gpios[] = {
	{
		...
		//.num	= EXYNOS4_GPJ1(3),	/* GPIO_CAM_MCLK */
                .num	= EXYNOS4210_GPJ1(3),	/* GPIO_CAM_MCLK */  //KAMALNATH - need to confirm
		.cfg	= S3C_GPIO_INPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
...
#ifdef CONFIG_USB_SAMSUNG_LTE //Added by KAMALNATH
	/* LTE PWR */
...
#ifdef CONFIG_SAMSUNG_PHONE_DPRAM_INTERNAL_MODULE	//Added by KAMALNATH
	...
	{EXYNOS4_GPX3(4), S3C_GPIO_INPUT, 2, S3C_GPIO_PULL_NONE}, /* T_FLASH_DETECT */
	{EXYNOS4_GPX3(5), S3C_GPIO_INPUT, 2, S3C_GPIO_PULL_NONE}, /* CP_AP_DPRAM_INT */
...
//	{EXYNOS4_GPE0(4), S3C_GPIO_INPUT, 2, S3C_GPIO_PULL_DOWN},
	{EXYNOS4210_GPE0(4), S3C_GPIO_INPUT, 2, S3C_GPIO_PULL_DOWN}, //KAMALNATH - need to confirm
...
static unsigned int p8lte_sleep_gpio_table[][3] = {
	...
	{ EXYNOS4210_GPE0(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, //Kamalnath - need to confirm all the below items
	...
	{ EXYNOS4_GPK1(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* WLAN_EN2 */
	...
	{ EXYNOS4_GPL1(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* ACCESSORY_EN */
	...
	{ EXYNOS4_GPY0(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* UART_SEL1 */
	...
	{ EXYNOS4_GPY3(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* V_ACCESSORY_5V CHECK */
	...
	{ EXYNOS4_GPY3(7),  S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE}, /* PDA_ACTIVE2 */

	{ EXYNOS4_GPY4(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},
	{ EXYNOS4_GPY4(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE},
	{ EXYNOS4_GPY4(2),  S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE}, /* PDA_ACTIVE */
	{ EXYNOS4_GPY4(3),  S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},
	{ EXYNOS4_GPY4(4),  S3C_GPIO_SLP_OUT0,	S3C_GPIO_PULL_NONE},
	{ EXYNOS4_GPY4(5),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* USB_SEL3 */
	{ EXYNOS4_GPY4(6),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* USB_SEL2 */
	{ EXYNOS4_GPY4(7),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* UART_SEL0 */

	{ EXYNOS4_GPY5(0),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* HW_REV0 */
	{ EXYNOS4_GPY5(1),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* HW_REV1 */
	{ EXYNOS4_GPY5(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* HW_REV2 */
	{ EXYNOS4_GPY5(3),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_NONE}, /* HW_REV3 */
	{ EXYNOS4_GPY5(4),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* GPS_nRST */
	{ EXYNOS4_GPY5(5),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE}, /* GPS_PWR_EN */
	...
	{ EXYNOS4_GPY6(4),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* USB_SEL1 */
